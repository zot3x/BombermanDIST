...
public class GameApplet extends JApplet {
	...
	static final int CANVAS_HEIGHT = 800; // make sure to set it in the HTML
											// also
	...
	private void gameDraw(Graphics2D g2d) {
		...
		case PLAYING:
			 ...
			 * 
			 * for (int i = 0; i < (map.getHeight()); i++) { for (int j = 0; j <
			 * (map.getWidth()); j++) { System.out.print(grid[i][j] + " "); if
			 * (j == map.getWidth() - 1) { System.out.println(); } } }
			 * 
